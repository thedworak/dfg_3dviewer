...
})({"4US5r":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "d093d4cae65223ac";
"use strict";
...
},{}],"evW6u":[function(require,module,exports,__globalThis) {
    ...
    createMaterial_(materialName) {
        ...
        for(const prop in mat){
            ...
            switch(prop.toLowerCase()){
                ...
                case 'kd':
                    // Diffuse color (color under white light) using RGB values
                    params.color = (0, _three.ColorManagement).colorSpaceToWorking(new (0, _three.Color)().fromArray(value), (0, _three.SRGBColorSpace));
                    break;
                case 'ks':
                    // Specular color (color when light is reflected from shiny surface) using RGB values
                    params.specular = (0, _three.ColorManagement).colorSpaceToWorking(new (0, _three.Color)().fromArray(value), (0, _three.SRGBColorSpace));
                    break;
                case 'ke':
                    // Emissive using RGB values
                    params.emissive = (0, _three.ColorManagement).colorSpaceToWorking(new (0, _three.Color)().fromArray(value), (0, _three.SRGBColorSpace));
                    break;
                case 'map_kd':
                    // Diffuse texture map
...
},{"three":"hJIVG","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["4US5r"], null, "parcelRequire6840", {})

//# sourceMappingURL=MTLLoader.e65223ac.js.map

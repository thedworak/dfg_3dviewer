...
})({"a0JRW":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "422a646a43bc6d52";
"use strict";
...
},{}],"7duZu":[function(require,module,exports,__globalThis) {
 ...
 */ class DRACOLoader extends (0, _three.Loader) {
    ...
    _createGeometry(geometryData) {
        ...
        for(let i = 0; i < geometryData.attributes.length; i++){
            ...
            let attribute;
            if (itemSize === stride) attribute = new (0, _three.BufferAttribute)(array, itemSize);
            else {
                const buffer = new (0, _three.InterleavedBuffer)(array, stride);
                attribute = new (0, _three.InterleavedBufferAttribute)(buffer, itemSize, 0);
            }
            if (name === 'color') {
    ...
    _assignVertexColorSpace(attribute, inputColorSpace) {
        ...
        for(let i = 0, il = attribute.count; i < il; i++){
            ...
            (0, _three.ColorManagement).colorSpaceToWorking(_color, (0, _three.SRGBColorSpace));
...
/* WEB WORKER */ function DRACOWorker() {
    ...
    function decodeAttribute(draco, decoder, dracoGeometry, attributeName, TypedArray, attribute) {
        ...
        let dstArray;
        if (srcByteStride === dstByteStride) // THREE.BufferAttribute
...
},{"three":"hJIVG","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["a0JRW"], null, "parcelRequire6840", {})

//# sourceMappingURL=DRACOLoader.43bc6d52.js.map

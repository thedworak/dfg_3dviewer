import { g as getDefaultExportFromNamespaceIfNotNamed, c as core } from './main-fgOE4_r6.js';
...
function getModule() {
    ...
    var DYNAMIC_BASE = 5265264, DYNAMICTOP_PTR = 22176;
    ...
    (Module['_emscripten_get_sbrk_ptr'] =
...
function parseLASMesh(arrayBuffer, options = {}) {
    ...
    parseLASChunked(arrayBuffer, options.las?.skip ?? 1, (decoder = {}, lasHeader) => {
        if (!originalHeader) {
 ...
 */
/* eslint-enable max-statements */
function parseLASChunked(rawData, skip = 1, onParseData = {}) {
...
//# sourceMappingURL=pointcloud-las-stnh9SBr.js.map

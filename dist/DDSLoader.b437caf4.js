...
})({"b6Zts":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "e4a9e521b437caf4";
"use strict";
...
},{}],"8zRzV":[function(require,module,exports,__globalThis) {
 ...
 */ class DDSLoader extends (0, _three.CompressedTextureLoader) {
    /**
	 ...
	 */ parse(buffer, loadMipmaps) {
        ...
        switch(fourCC){
            case FOURCC_DXT1:
                blockBytes = 8;
                dds.format = (0, _three.RGB_S3TC_DXT1_Format);
                break;
            case FOURCC_DXT3:
                blockBytes = 16;
                dds.format = (0, _three.RGBA_S3TC_DXT3_Format);
                break;
            case FOURCC_DXT5:
                blockBytes = 16;
                dds.format = (0, _three.RGBA_S3TC_DXT5_Format);
                break;
            case FOURCC_ETC1:
                blockBytes = 8;
                dds.format = (0, _three.RGB_ETC1_Format);
                break;
            case FOURCC_DX10:
                ...
                switch(dxgiFormat){
                    case DXGI_FORMAT_BC6H_SF16:
                        blockBytes = 16;
                        dds.format = (0, _three.RGB_BPTC_SIGNED_Format);
                        break;
                    case DXGI_FORMAT_BC6H_UF16:
                        blockBytes = 16;
                        dds.format = (0, _three.RGB_BPTC_UNSIGNED_Format);
                        break;
                    default:
            ...
            default:
                if (header[off_RGBBitCount] === 32 && header[off_RBitMask] & 0xff0000 && header[off_GBitMask] & 0xff00 && header[off_BBitMask] & 0xff && header[off_ABitMask] & 0xff000000) {
                    ...
                    blockBytes = 64;
                    dds.format = (0, _three.RGBAFormat);
...
},{"three":"hJIVG","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["b6Zts"], null, "parcelRequire6840", {})

//# sourceMappingURL=DDSLoader.b437caf4.js.map

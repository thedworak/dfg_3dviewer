...
})({"8XWPl":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "cdf58c367f5a29bc";
"use strict";
...
},{}],"bAj54":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "KMZLoader", ()=>KMZLoader);
 ...
 */ class KMZLoader extends (0, _three.Loader) {
    /**
	 ...
	 */ parse(data) {
        function findFile(url) {
            for(const path in zip){
                if (path.slice(-url.length) === url) return zip[path];
            }
        }
        ...
        //
        const zip = (0, _fflateModuleJs.unzipSync)(new Uint8Array(data));
        if (zip['doc.kml']) {
            const xml = new DOMParser().parseFromString(new TextDecoder().decode(zip['doc.kml']), 'application/xml');
            const model = xml.querySelector('Placemark Model Link href');
            if (model) {
                const loader = new (0, _colladaLoaderJs.ColladaLoader)(manager);
        ...
        return {
            scene: new (0, _three.Group)()
        };
    }
}

},{"three":"hJIVG","../loaders/ColladaLoader.js":"8mT2F","../libs/fflate.module.js":"4fbyW","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["8XWPl"], null, "parcelRequire6840", {})

//# sourceMappingURL=KMZLoader.7f5a29bc.js.map
